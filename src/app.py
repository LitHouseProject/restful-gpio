...
api = Api(app,
		  version='1.0',
		  title='Rest API rpi',
		  description='Proof of concept with a RESTful API and react web app to control gpio pins',
		  doc='/docs')
...
pin_util = PinUtil()
pin_util.create({'pin_num': 2, 'color': 'red', 'state': 'off'})
pin_util.create({'pin_num': 3, 'color': 'yellow', 'state': 'off'})
pin_util.create({'pin_num': 4, 'color': 'blue', 'state': 'off'})
